...
func TestRespondErrorPurchaseContract(t *testing.T) {
	tests := []struct {
		...
		{"购买处理中", "purchase_in_progress", "购买请求正在处理中，可在“最近购买尝试”中查看状态", application.ErrConflict, http.StatusConflict},
		{"结果待确认", "purchase_result_unknown", "购买结果尚未确认，请在“最近购买尝试”中查看状态，请勿重复购买", application.ErrConflict, http.StatusConflict},
		...
		{"供应商错误", "provider_error", "供应商响应异常，请在“最近购买尝试”中查看状态，请勿重复购买", application.ErrProvider, http.StatusBadGateway},
		...
		{"保存失败", "database_error", "购买结果保存异常，请在“最近购买尝试”中查看状态，请勿重复购买", nil, http.StatusInternalServerError},
